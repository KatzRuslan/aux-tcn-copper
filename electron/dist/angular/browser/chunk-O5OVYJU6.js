...
// src/app/store/app.helper.ts
var ctx;
function initAppHelperContext(context) {
  ctx = context;
}
function showConfirmDialog({ header, message, accept, reject, acceptButtonProps, rejectButtonProps }) {
  ctx.confirmationService.confirm({
    ...
    acceptButtonProps: __spreadValues({
      label: "OK"
    }, acceptButtonProps),
    reject: () => {
      reject?.();
    },
    rejectButtonProps: __spreadValues({
      label: "Close",
      severity: "secondary",
      outlined: true
    }, rejectButtonProps),
...
function copyToClipboard(copy, detail) {
  navigator.clipboard.writeText(copy).then(() => showToastMessages([{
    detail: `"${detail}" was copied to clipboard`,
    severity: "success"
  }]));
}
function changeThemeMode(isDark) {
...
function generateHash(value) {
  ...
  for (let chunkOffset = 0; chunkOffset < paddedLengthInBytes; chunkOffset += 64) {
    for (let i2 = 0; i2 < 16; i2++) {
      messageSchedule[i2] = paddedBytesView.getUint32(chunkOffset + i2 * 4, false);
    }
    for (let i2 = 16; i2 < 64; i2++) {
      const prevWord15 = messageSchedule[i2 - 15];
      const sigma0 = ((prevWord15 >>> 7 | prevWord15 << 25) ^ (prevWord15 >>> 18 | prevWord15 << 14) ^ prevWord15 >>> 3) >>> 0;
      const prevWord2 = messageSchedule[i2 - 2];
      const sigma1 = ((prevWord2 >>> 17 | prevWord2 << 15) ^ (prevWord2 >>> 19 | prevWord2 << 13) ^ prevWord2 >>> 10) >>> 0;
      messageSchedule[i2] = messageSchedule[i2 - 16] + sigma0 + messageSchedule[i2 - 7] + sigma1 >>> 0;
    }
    ...
    for (let i2 = 0; i2 < 64; i2++) {
      ...
      const temp1 = workingStateH + capitalSigma1 + chFunction + SHA256_ROUND_CONSTANTS[i2] + messageSchedule[i2] >>> 0;
...
function makeHttpResourceFn(responseType) {
  return function httpResource2(request, options) {
    ...
    return new HttpResourceImpl(injector, (ctx2) => normalizeRequest(ctx2, request, responseType), options?.defaultValue, options?.debugName, options?.parse, options?.equal, getInitialStream);
  };
}
function normalizeRequest(ctx2, request, responseType) {
  let unwrappedRequest = typeof request === "function" ? request(ctx2) : request;
...
function makeToSignalEqual(userEquality = Object.is) {
  return (a2, b4) => a2.kind === 1 && b4.kind === 1 && userEquality(a2.value, b4.value);
}
...
function b(e, t, n = /* @__PURE__ */ new WeakSet()) {
  ...
  if (f = F2.length, f !== Object.keys(t).length) return false;
  for (u = f; u-- !== 0; ) if (!Object.prototype.hasOwnProperty.call(t, F2[u])) return false;
  for (u = f; u-- !== 0; ) if (T2 = F2[u], !b(e[T2], t[T2], n)) return false;
  return true;
}
function y(e, t) {
  return b(e, t);
...
function V2(t, e, o = true) {
  var n, r, i2, s3;
  if (t) {
    let a2 = t.offsetParent ? { width: t.offsetWidth, height: t.offsetHeight } : v(t), l2 = a2.height, d2 = a2.width, f = e.offsetHeight, c2 = e.offsetWidth, u = e.getBoundingClientRect(), g2 = D(), w2 = $2(), st2 = y2(), W, N3, nt = "top";
    u.top + f + l2 > st2.height ? (W = u.top + g2 - l2, nt = "bottom", W < 0 && (W = g2)) : W = f + u.top + g2, u.left + d2 > st2.width ? N3 = Math.max(0, u.left + w2 + c2 - d2) : N3 = u.left + w2, I(t) ? t.style.insetInlineEnd = N3 + "px" : t.style.insetInlineStart = N3 + "px", t.style.top = W + "px", t.style.transformOrigin = nt, o && (t.style.marginTop = nt === "bottom" ? `calc(${(r = (n = E2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (s3 = (i2 = E2(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? s3 : "");
  }
}
function T(t, e) {
...
function j(t, e, o = true, n = void 0) {
  var r;
  if (t) {
    let i2 = t.offsetParent ? { width: t.offsetWidth, height: t.offsetHeight } : v(t), s3 = e.offsetHeight, a2 = e.getBoundingClientRect(), l2 = y2(), d2, f, c2 = n != null ? n : "top";
    if (!n && a2.top + s3 + i2.height > l2.height ? (d2 = -1 * i2.height, c2 = "bottom", a2.top + d2 < 0 && (d2 = -1 * a2.top)) : d2 = s3, i2.width > l2.width ? f = a2.left * -1 : a2.left + i2.width > l2.width ? f = (a2.left + i2.width - l2.width) * -1 : f = 0, t.style.top = d2 + "px", t.style.insetInlineStart = f + "px", t.style.transformOrigin = c2, o) {
      let u = (r = E2(/-anchor-gutter$/)) == null ? void 0 : r.value;
      t.style.marginTop = c2 === "bottom" ? `calc(${u != null ? u : "2px"} * -1)` : u != null ? u : "";
    }
  }
}
function h2(t) {
...
function U(t, e) {
  ...
  if (t) switch (t) {
    ...
    default: {
      if (typeof t == "string") {
        let l2 = t.match(/^@child\[(\d+)]/);
        return l2 ? ((r = e == null ? void 0 : e.children) == null ? void 0 : r[parseInt(l2[1], 10)]) || null : document.querySelector(t) || null;
      }
      let s3 = ((l2) => typeof l2 == "function" && "call" in l2 && "apply" in l2)(t) ? t() : t, a2 = b2(s3);
...
function O(t, e = {}) {
  if (p2(t)) {
    let o = (r, i2) => {
      var a2, l2;
      let s3 = (a2 = t == null ? void 0 : t.$attrs) != null && a2[r] ? [(l2 = t == null ? void 0 : t.$attrs) == null ? void 0 : l2[r]] : [];
      return [i2].flat().reduce((d2, f) => {
        if (f != null) {
          let c2 = typeof f;
          if (c2 === "string" || c2 === "number") d2.push(f);
          else if (c2 === "object") {
            ...
            d2 = u.length ? d2.concat(u.filter((g2) => !!g2)) : d2;
          }
        }
        return d2;
      }, s3);
      ...
      o("style", r).forEach((s3) => {
        let a2 = s3.indexOf(":");
        if (a2 < 0) return;
        let l2 = s3.slice(0, a2).trim(), d2 = s3.slice(a2 + 1).trim();
        l2 && t.style.setProperty(l2, d2);
      });
    };
    Object.entries(e).forEach(([r, i2]) => {
      if (i2 != null) {
        let s3 = r.match(/^on(.+)/);
        s3 ? t.addEventListener(s3[1].toLowerCase(), i2) : r === "p-bind" || r === "pBind" ? O(t, i2) : r === "style" ? (n(i2), (t.$attrs = t.$attrs || {}) && (t.$attrs[r] = t.style.cssText)) : (i2 = r === "class" ? [...new Set(o("class", i2))].join(" ").trim() : i2, (t.$attrs = t.$attrs || {}) && (t.$attrs[r] = i2), t.setAttribute(r, i2));
      }
    });
  }
}
...
function Zt(t, e) {
  var o, n;
  if (t) {
    let r = t.parentElement, i2 = _(r), s3 = y2(), a2 = t.offsetParent ? t.offsetWidth : K2(t), l2 = t.offsetParent ? t.offsetHeight : J2(t), d2 = C2((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), f = L((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), c2 = "", u = "";
    i2.left + d2 + a2 > s3.width - A() ? i2.left < a2 ? e % 2 === 1 ? c2 = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (c2 = s3.width - a2 - A() + "px") : c2 = "-100%" : c2 = "100%", t.getBoundingClientRect().top + f + l2 > s3.height ? u = `-${l2 - f}px` : u = "0px", t.style.top = u, t.style.insetInlineStart = c2;
  }
}
function Qt() {
...
function _t(t, e) {
  let o = getComputedStyle(t).getPropertyValue("borderTopWidth"), n = o ? parseFloat(o) : 0, r = getComputedStyle(t).getPropertyValue("paddingTop"), i2 = r ? parseFloat(r) : 0, s3 = t.getBoundingClientRect(), l2 = e.getBoundingClientRect().top + document.body.scrollTop - (s3.top + document.body.scrollTop) - n - i2, d2 = t.scrollTop, f = t.clientHeight, c2 = L(e);
  l2 < 0 ? t.scrollTop = d2 + l2 : l2 + c2 > f && (t.scrollTop = d2 + l2 - f + c2);
}
function te(t, e = "", o) {
  if (p2(t) && o !== null && o !== void 0) {
    if (e === "style") {
      typeof o == "string" ? t.style.cssText = o : typeof o == "object" && Object.entries(o).forEach(([n, r]) => {
        if (r == null) return;
        let i2 = n.startsWith("--") ? n : n.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
        t.style.setProperty(i2, String(r));
      });
      return;
    }
    t.setAttribute(e, o);
...
var Header = class _Header {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    decls: 1,
    vars: 0,
    template: function Header_Template(rf, ctx2) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
        \u0275\u0275projection(0);
      }
...
var Footer = class _Footer {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    decls: 1,
    vars: 0,
    template: function Footer_Template(rf, ctx2) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
        \u0275\u0275projection(0);
      }
...
var rt2 = Object.getOwnPropertyDescriptors;
var Y3 = Object.getOwnPropertySymbols;
var _e = Object.prototype.hasOwnProperty;
var be = Object.prototype.propertyIsEnumerable;
var xe = (e, t, s3) => t in e ? tt(e, t, { enumerable: true, configurable: true, writable: true, value: s3 }) : e[t] = s3;
var _2 = (e, t) => {
  for (var s3 in t || (t = {})) _e.call(t, s3) && xe(e, s3, t[s3]);
  if (Y3) for (var s3 of Y3(t)) be.call(t, s3) && xe(e, s3, t[s3]);
  return e;
};
var E3 = (e, t) => st(e, rt2(t));
var N2 = (e, t) => {
  var s3 = {};
  for (var r in e) _e.call(e, r) && t.indexOf(r) < 0 && (s3[r] = e[r]);
  if (e != null && Y3) for (var r of Y3(e)) t.indexOf(r) < 0 && be.call(e, r) && (s3[r] = e[r]);
  return s3;
};
function ke(...e) {
  return w(...e);
...
var se2 = /var\([^)]+\)/g;
function z2(e) {
  return a(e) ? e.replace(/[A-Z]/g, (t, s3) => s3 === 0 ? t : "." + t.toLowerCase()).toLowerCase() : e;
}
function ve(e) {
...
function re2(e = "", t = "") {
  return ut2(`${a(e, false) && a(t, false) ? `${e}-` : e}${t}`);
}
function le(e = "", t = "") {
  return `--${re2(e, t)}`;
}
...
function M2(e, t = "", s3 = "", r = [], i2) {
  if (a(e)) {
    let o = e.trim();
    if (mt(o)) return;
    if (G(o, v2)) {
      let n = o.replaceAll(v2, (m3) => {
        let a2 = m3.replace(/{|}/g, "").split(".").filter((l2) => !r.some((c2) => G(l2, c2)));
        return `var(${le(s3, re(a2.join("-")))}${s(i2) ? `, ${i2}` : ""})`;
      });
      return G(n.replace(se2, "0"), te2) ? `calc(${n})` : n;
    }
    return o;
  } else if (z(e)) return e;
}
function Re(e, t, s3) {
  a(t, false) && e.push(`${t}:${s3};`);
}
function V3(e, t) {
  return e ? `${e}{${t}}` : "";
}
function ce(e, t) {
  ...
  function s3(n, m3) {
    let d2 = [], a2 = 0, l2 = "", c2 = null, h3 = 0;
    for (; a2 <= n.length; ) {
      let f = n[a2];
      if ((f === '"' || f === "'" || f === "`") && n[a2 - 1] !== "\\" && (c2 = c2 === f ? null : f), !c2 && (f === "(" && h3++, f === ")" && h3--, (f === "," || a2 === n.length) && h3 === 0)) {
        let y3 = l2.trim();
        y3.startsWith("dt(") ? d2.push(ce(y3, m3)) : d2.push(r(y3)), l2 = "", a2++;
        continue;
      }
      f !== void 0 && (l2 += f), a2++;
    }
  ...
  function r(n) {
    let m3 = n[0];
    if ((m3 === '"' || m3 === "'" || m3 === "`") && n[n.length - 1] === m3) return n.slice(1, -1);
    let d2 = Number(n);
    return isNaN(d2) ? n : d2;
  }
  let i2 = [], o = [];
  for (let n = 0; n < e.length; n++) if (e[n] === "d" && e.slice(n, n + 3) === "dt(") o.push(n), n += 2;
  else if (e[n] === ")" && o.length > 0) {
    let m3 = o.pop();
    o.length === 0 && i2.push([m3, n]);
  }
  if (!i2.length) return e;
  for (let n = i2.length - 1; n >= 0; n--) {
    let [m3, d2] = i2[n], a2 = e.slice(m3 + 3, d2), l2 = s3(a2, t), c2 = t(...l2);
    e = e.slice(0, m3) + c2 + e.slice(d2 + 1);
  }
  return e;
}
var St = (e, t) => {
  ...
  for (let i2 = 0; i2 < s3.length; i2++) {
    let o = z2(s3[i2]);
    t.lastIndex = 0, !t.test(o) && (r = r ? `${r}.${o}` : o);
  }
  return r;
};
var xt2 = (e, t, s3, r) => {
  var l2, c2, h3;
  let i2 = b3.tokens, o = St(e, s3), n = i2.__strictCache;
  n || (n = /* @__PURE__ */ new Map(), Object.defineProperty(i2, "__strictCache", { value: n, enumerable: false, configurable: true }));
  let m3 = r ? `${t}|${o}|${r}` : `${t}|${o}`;
  if (n.has(m3)) return n.get(m3);
  let d2 = (h3 = (c2 = (l2 = i2[o]) == null ? void 0 : l2.paths) == null ? void 0 : c2[0]) == null ? void 0 : h3.value, a2;
  if (typeof d2 != "string") a2 = d2 != null ? d2 : b3.getTokenValue(e);
  else if (v2.lastIndex = 0, !v2.test(d2)) a2 = d2;
  else {
    let f = o.slice(0, o.indexOf(".")), y3 = d2.replace(v2, (g2) => {
      let u = g2.slice(1, -1), p3 = u.indexOf(".");
      if ((p3 === -1 ? u : u.slice(0, p3)) !== f) return g2;
      let S2 = b3.getTokenValue(u);
      return S2 == null ? g2 : `${S2}`;
    });
    a2 = M2(y3, void 0, t, [s3], r);
  }
  return n.set(m3, a2), a2;
};
var ns = (e) => {
  var o;
  let t = b3.getTheme(), s3 = me(t, e, void 0, "variable"), r = (o = s3 == null ? void 0 : s3.match(/--[\w-]+/g)) == null ? void 0 : o[0], i2 = me(t, e, void 0, "value");
  return { name: r, variable: s3, value: i2 };
};
var P2 = (...e) => me(b3.getTheme(), ...e);
var me = (e = {}, t, s3, r) => {
  var d2, a2, l2, c2, h3, f, y3, g2, u, p3;
  if (!t) return "";
  let i2 = (d2 = b3.defaults) == null ? void 0 : d2.variable, o = (h3 = (a2 = e == null ? void 0 : e.options) == null ? void 0 : a2.prefix) != null ? h3 : (c2 = (l2 = b3.defaults) == null ? void 0 : l2.options) == null ? void 0 : c2.prefix, n = (p3 = (u = (f = e == null ? void 0 : e.options) == null ? void 0 : f.cssVariables) != null ? u : (g2 = (y3 = b3.defaults) == null ? void 0 : y3.options) == null ? void 0 : g2.cssVariables) != null ? p3 : true;
  if (r === "value") return b3.getTokenValue(t);
  if (l(r) && !n) return xt2(t, o, i2.excludedKeyRegex, s3);
  let m3 = G(t, v2) ? t : `{${t}}`;
  return M2(m3, void 0, o, [i2.excludedKeyRegex], s3);
};
function cs(e, ...t) {
  if (e instanceof Array) {
    let s3 = e.reduce((r, i2, o) => {
      var n;
      return r + i2 + ((n = m(t[o], { dt: P2 })) != null ? n : "");
    }, "");
    return ce(s3, P2);
  }
  return m(e, { dt: P2 });
...
function ge(e, t = {}) {
  let s3 = b3.defaults.variable, { prefix: r = s3.prefix, selector: i2 = s3.selector, excludedKeyRegex: o = s3.excludedKeyRegex } = t, n = [], m3 = [], d2 = [{ node: e, path: r }];
  for (; d2.length; ) {
    let { node: l2, path: c2 } = d2.pop();
    for (let h3 in l2) {
      let f = l2[h3], y3 = ve(f), u = G(h3, o) ? re2(c2) : re2(c2, re(h3));
      if (i(y3)) d2.push({ node: y3, path: u });
      else {
        let p3 = le(u), S2 = M2(y3, u, r, [o]);
        Re(m3, p3, S2);
        let x2 = u;
        r && x2.startsWith(r + "-") && (x2 = x2.slice(r.length + 1)), n.push(x2.replace(/-/g, "."));
      }
    }
  }
  let a2 = m3.join("");
  return { value: m3, tokens: n, declarations: a2, css: V3(i2, a2) };
}
var R2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  return [e].flat().map((s3) => {
    var r;
    return (r = t.map((i2) => i2.resolve(s3)).find((i2) => i2.matched)) != null ? r : this.rules.custom.resolve(s3);
  });
} }, _toVariables(e, t) {
  return ge(e, { prefix: t == null ? void 0 : t.prefix });
}, getCommon({ name: e = "", theme: t = {}, params: s3, set: r, defaults: i2 }) {
  var S2, x2, k3, T2, w2, C3, L2;
  let { preset: o, options: n } = t, m3, d2, a2, l2, c2, h3, f;
  if (s(o)) {
    let { primitive: j2, semantic: I2, extend: ie2 } = o, y3 = I2 || {}, { colorScheme: oe2 } = y3, K3 = N2(y3, ["colorScheme"]), g2 = ie2 || {}, { colorScheme: U2 } = g2, X2 = N2(g2, ["colorScheme"]), u = oe2 || {}, { dark: B2 } = u, H2 = N2(u, ["dark"]), p3 = U2 || {}, { dark: W } = p3, q3 = N2(p3, ["dark"]), Z2 = s(j2) ? this._toVariables({ primitive: j2 }, n) : {}, F2 = s(K3) ? this._toVariables({ semantic: K3 }, n) : {}, J3 = s(H2) ? this._toVariables({ light: H2 }, n) : {}, Q2 = s(B2) ? this._toVariables({ dark: B2 }, n) : {}, pe = s(X2) ? this._toVariables({ semantic: X2 }, n) : {}, ye = s(q3) ? this._toVariables({ light: q3 }, n) : {}, Se = s(W) ? this._toVariables({ dark: W }, n) : {}, [je, Ke] = [(S2 = Z2.declarations) != null ? S2 : "", Z2.tokens], [Xe, ze] = [(x2 = F2.declarations) != null ? x2 : "", F2.tokens || []], [Me, Ge] = [(k3 = J3.declarations) != null ? k3 : "", J3.tokens || []], [Ie, Ue] = [(T2 = Q2.declarations) != null ? T2 : "", Q2.tokens || []], [Be, He] = [(w2 = pe.declarations) != null ? w2 : "", pe.tokens || []], [We, qe] = [(C3 = ye.declarations) != null ? C3 : "", ye.tokens || []], [Ze, Fe] = [(L2 = Se.declarations) != null ? L2 : "", Se.tokens || []];
    m3 = this.transformCSS(e, je, "light", "variable", n, r, i2), d2 = Ke;
    let Je = this.transformCSS(e, `${Xe}${Me}`, "light", "variable", n, r, i2), Qe = this.transformCSS(e, `${Ie}`, "dark", "variable", n, r, i2);
    a2 = `${Je}${Qe}`, l2 = [.../* @__PURE__ */ new Set([...ze, ...Ge, ...Ue])];
    let Ye = this.transformCSS(e, `${Be}${We}color-scheme:light`, "light", "variable", n, r, i2), et2 = this.transformCSS(e, `${Ze}color-scheme:dark`, "dark", "variable", n, r, i2);
    c2 = `${Ye}${et2}`, h3 = [.../* @__PURE__ */ new Set([...He, ...qe, ...Fe])], f = m(o.css, { dt: P2 });
  }
  return { primitive: { css: m3, tokens: d2 }, semantic: { css: a2, tokens: l2 }, global: { css: c2, tokens: h3 }, style: f };
}, getPreset({ name: e = "", preset: t = {}, options: s3, params: r, set: i2, defaults: o, selector: n }) {
  var l2, g2, u, p3;
  let m3, d2, a2;
  if (s(t) && ((l2 = s3.cssVariables) == null || l2)) {
    let S2 = e.replace("-directive", ""), c2 = t, { colorScheme: x2, extend: k3, css: T2 } = c2, w2 = N2(c2, ["colorScheme", "extend", "css"]), h3 = k3 || {}, { colorScheme: C3 } = h3, L2 = N2(h3, ["colorScheme"]), f = x2 || {}, { dark: j2 } = f, I2 = N2(f, ["dark"]), y3 = C3 || {}, { dark: ie2 } = y3, oe2 = N2(y3, ["dark"]), K3 = s(w2) ? this._toVariables({ [S2]: _2(_2({}, w2), L2) }, s3) : {}, U2 = s(I2) ? this._toVariables({ [S2]: _2(_2({}, I2), oe2) }, s3) : {}, X2 = s(j2) ? this._toVariables({ [S2]: _2(_2({}, j2), ie2) }, s3) : {}, [B2, H2] = [(g2 = K3.declarations) != null ? g2 : "", K3.tokens || []], [W, q3] = [(u = U2.declarations) != null ? u : "", U2.tokens || []], [Z2, F2] = [(p3 = X2.declarations) != null ? p3 : "", X2.tokens || []], J3 = this.transformCSS(S2, `${B2}${W}`, "light", "variable", s3, i2, o, n), Q2 = this.transformCSS(S2, Z2, "dark", "variable", s3, i2, o, n);
    m3 = `${J3}${Q2}`, d2 = [.../* @__PURE__ */ new Set([...H2, ...q3, ...F2])], a2 = m(T2, { dt: P2 });
  }
  return { css: m3, tokens: d2, style: a2 };
}, getScopedSelector(e, t) {
  if (!(!(t != null && t.scoped) || !e)) return `[data-styled="${e}"]`;
}, getPresetC({ name: e = "", theme: t = {}, params: s3, set: r, defaults: i2 }) {
  var a2;
  let { preset: o, options: n } = t, m3 = (a2 = o == null ? void 0 : o.components) == null ? void 0 : a2[e], d2 = this.getScopedSelector(e, n);
  return this.getPreset({ name: e, preset: m3, options: n, params: s3, set: r, defaults: i2, selector: d2 });
}, getPresetD({ name: e = "", theme: t = {}, params: s3, set: r, defaults: i2 }) {
  var l2, c2;
  let o = e.replace("-directive", ""), { preset: n, options: m3 } = t, d2 = ((l2 = n == null ? void 0 : n.components) == null ? void 0 : l2[o]) || ((c2 = n == null ? void 0 : n.directives) == null ? void 0 : c2[o]), a2 = this.getScopedSelector(o, m3);
  return this.getPreset({ name: o, preset: d2, options: m3, params: s3, set: r, defaults: i2, selector: a2 });
  ...
  let { cssLayer: i2 } = t;
  return i2 ? `@layer ${m(i2.order || i2.name || "primeui", s3)}` : "";
}, getCommonStyleSheet({ name: e = "", theme: t = {}, params: s3, props: r = {}, set: i2, defaults: o }) {
  let n = this.getCommon({ name: e, theme: t, params: s3, set: i2, defaults: o }), m3 = Object.entries(r).reduce((d2, [a2, l2]) => d2.push(`${a2}="${l2}"`) && d2, []).join(" ");
  return Object.entries(n || {}).reduce((d2, [a2, l2]) => {
    if (i(l2) && Object.hasOwn(l2, "css")) {
      let c2 = Y(l2.css), h3 = `${a2}-variables`;
      d2.push(`<style type="text/css" data-primevue-style-id="${h3}" ${m3}>${c2}</style>`);
    }
    return d2;
  }, []).join("");
}, getStyleSheet({ name: e = "", theme: t = {}, params: s3, props: r = {}, set: i2, defaults: o }) {
  var a2;
  let n = { name: e, theme: t, params: s3, set: i2, defaults: o }, m3 = (a2 = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : a2.css, d2 = Object.entries(r).reduce((l2, [c2, h3]) => l2.push(`${c2}="${h3}"`) && l2, []).join(" ");
  return m3 ? `<style type="text/css" data-primevue-style-id="${e}-variables" ${d2}>${Y(m3)}</style>` : "";
}, createTokens(e = {}, t, s3 = "", r = "", i2 = {}) {
  let o = function(a2, l2, c2, h3) {
    return a2.replace(v2, (f) => {
      var p3;
      let y3 = f.slice(1, -1), g2 = this.tokens[y3];
      if (!g2) return console.warn(`Token not found for path: ${y3}`), "__UNRESOLVED__";
      let u = g2.computed(l2, c2, h3);
      if (Array.isArray(u) && u.length === 2) {
        let S2 = u[0].value, x2 = u[1].value;
        return S2 === x2 ? S2 != null ? S2 : "__UNRESOLVED__" : `light-dark(${S2},${x2})`;
      }
      return (p3 = u == null ? void 0 : u.value) != null ? p3 : "__UNRESOLVED__";
    });
  }, n = function(a2, l2, c2, h3) {
    if (a2.indexOf("light-dark(") === -1) return a2;
    let f = [], y3 = a2.length, g2 = 0;
    for (; g2 < y3; ) {
      let u = a2.indexOf("light-dark(", g2);
      if (u === -1) {
        f.push(a2.slice(g2));
        break;
      }
      f.push(a2.slice(g2, u));
      let p3 = 1, S2 = u + 11, x2 = -1;
      for (; S2 < y3 && p3 > 0; ) {
        let C3 = a2.charCodeAt(S2);
        C3 === 40 ? p3++ : C3 === 41 ? p3-- : C3 === 44 && p3 === 1 && x2 === -1 && (x2 = S2), S2++;
      }
      if (p3 !== 0 || x2 === -1) {
        f.push(a2.slice(u));
        break;
      }
      let k3 = a2.slice(u + 11, x2).trim(), T2 = a2.slice(x2 + 1, S2 - 1).trim(), w2 = l2 && l2 !== "none" ? l2 : null;
      if (w2 === "light") f.push(n.call(this, k3, "light", c2, h3));
      else if (w2 === "dark") f.push(n.call(this, T2, "dark", c2, h3));
      else {
        let C3 = o.call(this, n.call(this, k3, "light", c2, h3), "light", c2, h3), L2 = o.call(this, n.call(this, T2, "dark", c2, h3), "dark", c2, h3);
        f.push(C3 === L2 ? C3 : `light-dark(${C3},${L2})`);
      }
      g2 = S2;
    }
    return f.join("");
  }, m3 = function(a2, l2 = {}, c2 = []) {
    if (c2.includes(this.path)) return console.warn(`Circular reference detected at ${this.path}`), { colorScheme: a2, path: this.path, paths: l2, value: void 0 };
    c2.push(this.path), l2.name = this.path, l2.binding || (l2.binding = {});
    let h3 = this.value;
    if (typeof this.value == "string") {
      let f = this.value.trim(), y3 = f.indexOf("light-dark(") !== -1, g2 = f.indexOf("{") !== -1;
      if (y3 || g2) {
        let u = y3 ? n.call(this, f, a2, l2, c2) : f, p3 = u.indexOf("{") !== -1 ? o.call(this, u, a2, l2, c2) : u;
        te2.lastIndex = 0, se2.lastIndex = 0, h3 = te2.test(p3.replace(se2, "0")) ? `calc(${p3})` : p3;
      }
    }
    return l(l2.binding) && delete l2.binding, c2.pop(), { colorScheme: a2, path: this.path, paths: l2, value: typeof h3 == "string" && h3.indexOf("__UNRESOLVED__") !== -1 ? void 0 : h3 };
  }, d2 = (a2, l2, c2) => {
    Object.entries(a2).forEach(([h3, f]) => {
      let y3 = G(h3, t.variable.excludedKeyRegex) ? l2 : l2 ? `${l2}.${z2(h3)}` : z2(h3), g2 = c2 ? `${c2}.${h3}` : h3;
      i(f) ? d2(f, y3, g2) : (i2[y3] || (i2[y3] = { paths: [], computed: (u, p3 = {}, S2 = []) => {
        let x2 = i2[y3].paths;
        if (x2.length === 1) {
          let k3 = x2[0], T2 = k3.scheme !== "none" ? k3.scheme : u;
          return k3.computed(T2, p3.binding, S2);
        } else if (u && u !== "none") for (let k3 = 0; k3 < x2.length; k3++) {
          let T2 = x2[k3];
          if (T2.scheme === u) return T2.computed(u, p3.binding, S2);
        }
        return x2.map((k3) => k3.computed(k3.scheme, p3[k3.scheme], S2));
      } }), i2[y3].paths.push({ path: g2, value: f, scheme: g2.includes("colorScheme.light") ? "light" : g2.includes("colorScheme.dark") ? "dark" : "none", computed: m3, tokens: i2 }));
    });
  };
  return d2(e, s3, r), i2;
  ...
  let i2 = r.get(t);
  if (i2 !== void 0 || r.has(t)) return i2;
  let o = s3.variable.excludedKeyRegex, n = t.split("."), m3 = [];
  for (let g2 = 0; g2 < n.length; g2++) {
    let u = n[g2];
    o.lastIndex = 0, o.test(u.toLowerCase()) || m3.push(u);
  }
  let d2 = m3.join("."), a2 = t.indexOf("colorScheme.light") !== -1 ? "light" : t.indexOf("colorScheme.dark") !== -1 ? "dark" : void 0, l2 = e[d2];
  if (!l2) {
    r.set(t, void 0);
    return;
  }
  let c2;
  if (a2) {
    let g2 = l2.computed(a2);
    if (Array.isArray(g2)) {
      for (let u = 0; u < g2.length; u++) if (((h3 = g2[u]) == null ? void 0 : h3.colorScheme) === a2) {
        c2 = g2[u].value;
        break;
      }
    } else c2 = g2 == null ? void 0 : g2.value;
  } else {
    let g2 = l2.computed("light"), u = l2.computed("dark"), p3, S2;
    if (Array.isArray(g2)) {
      for (let x2 = 0; x2 < g2.length; x2++) if (((f = g2[x2]) == null ? void 0 : f.colorScheme) === "light") {
        p3 = g2[x2].value;
        break;
      }
    } else p3 = g2 == null ? void 0 : g2.value;
    if (Array.isArray(u)) {
      for (let x2 = 0; x2 < u.length; x2++) if (((y3 = u[x2]) == null ? void 0 : y3.colorScheme) === "dark") {
        S2 = u[x2].value;
        break;
      }
    } else S2 = u == null ? void 0 : u.value;
    p3 === void 0 && S2 === void 0 ? c2 = void 0 : p3 === void 0 ? c2 = S2 : S2 === void 0 || p3 === S2 ? c2 = p3 : c2 = `light-dark(${p3},${S2})`;
  }
  return r.set(t, c2), c2;
}, getSelectorRule(e, t, s3, r, i2 = ":root,:host") {
  return s3 === "class" || s3 === "attr" ? V3(s(t) ? `${e}${t},${e} ${t}` : e, r) : V3(e, V3(t != null ? t : i2, r));
}, transformCSS(e, t, s3, r, i2 = {}, o, n, m3) {
  var d2, a2;
  if (s(t)) {
    let { cssLayer: l2 } = i2;
    if (r !== "style") {
      let c2 = this.getColorSchemeOption(i2, n), h3 = (a2 = (d2 = n == null ? void 0 : n.variable) == null ? void 0 : d2.selector) != null ? a2 : ":root,:host";
      t = s3 === "dark" ? c2.reduce((f, { type: y3, selector: g2 }) => (s(g2) && (f += g2.includes("[CSS]") ? g2.replace("[CSS]", t) : this.getSelectorRule(g2, m3, y3, t, h3)), f), "") : V3(m3 != null ? m3 : h3, t);
    }
    if (l2) {
      let c2 = { name: "primeui", order: "primeui" };
      i(l2) && (c2.name = m(l2.name, { name: e, type: r })), s(c2.name) && (t = V3(`@layer ${c2.name}`, t), o == null || o.layerNames(c2.name));
    }
    return t;
  }
  return "";
} };
var b3 = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false, cssVariables: true, scoped: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t } = e;
  t && (this._theme = E3(_2({}, t), { options: _2(_2({}, this.defaults.options), t.options) }), this._tokens = R2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this.update({ theme: e }), O2.emit("theme:change", e);
}, getPreset() {
  return this.preset;
}, setPreset(e) {
  this._theme = E3(_2({}, this.theme), { preset: e }), this._tokens = R2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), O2.emit("preset:change", e), O2.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
  this._theme = E3(_2({}, this.theme), { options: e }), this.clearLoadedStyleNames(), O2.emit("options:change", e), O2.emit("theme:change", this.theme);
}, getLayerNames() {
  ...
  return R2.getTokenValue(this.tokens, e, this.defaults);
}, getCommon(e = "", t) {
  return R2.getCommon({ name: e, theme: this.theme, params: t, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } });
}, getComponent(e = "", t) {
  let s3 = { name: e, theme: this.theme, params: t, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } };
  return R2.getPresetC(s3);
}, getDirective(e = "", t) {
  let s3 = { name: e, theme: this.theme, params: t, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } };
  return R2.getPresetD(s3);
}, getCustomPreset(e = "", t, s3, r) {
  let i2 = { name: e, preset: t, options: this.options, selector: s3, params: r, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } };
  return R2.getPreset(i2);
}, getLayerOrderCSS(e = "") {
  return R2.getLayerOrder(e, this.options, { names: this.getLayerNames() }, this.defaults);
}, transformCSS(e = "", t, s3 = "style", r) {
  return R2.transformCSS(e, t, r, s3, this.options, { layerNames: this.setLayerNames.bind(this) }, this.defaults);
}, getCommonStyleSheet(e = "", t, s3 = {}) {
  return R2.getCommonStyleSheet({ name: e, theme: this.theme, params: t, props: s3, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } });
}, getStyleSheet(e, t, s3 = {}) {
  return R2.getStyleSheet({ name: e, theme: this.theme, params: t, props: s3, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } });
}, onStyleMounted(e) {
  this._loadingStyles.add(e);
}, onStyleUpdated(e) {
  this._loadingStyles.add(e);
}, onStyleLoaded(e, { name: t }) {
  this._loadingStyles.size && (this._loadingStyles.delete(t), O2.emit(`theme:${t}:load`, e), !this._loadingStyles.size && O2.emit("theme:load"));
} };
function Ve(...e) {
  let t = w(b3.getPreset(), ...e);
  return b3.setPreset(t), t;
}
...
//# sourceMappingURL=chunk-O5OVYJU6.js.map
